            ...
            <div class="w-80 page-content">
                <div class="page-single-content">
                    <div class="card-body p-6">
                        <form method="post" action="<?php echo base_url('auth/resend_activation'); ?>" onsubmit="submit.disabled = true; return true;">
                            <div class="row">
                                <div class="col-md-8 mx-auto d-block">
                                    <div class="">
                                        ...
                                        <?php } ?>
                                        <h1 class="mb-2"><?php echo lang('resend_activation_heading'); ?></h1>
                                        <p class="text-muted"><?php echo sprintf(lang('resend_activation_subheading'), $identity_label); ?></p>
                                        <div class="input-group mb-4">
                                            ...
                                            <input type="email" name="email" value="" class="form-control" placeholder="<?php echo lang('resend_activation_email_identity_label'); ?>">
                                        </div>
                                        <div class="row">
                                            <div class="col-12">
                                                <button type="submit" name="submit" value="" class="btn btn-lg btn-primary btn-block px-4"><?php echo lang('resend_activation_submit_btn');?></button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="pt-4">
