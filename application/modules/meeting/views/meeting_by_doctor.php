                                            ...
                                            if ($meeting->doctor == $doctor_id) {
                                                ...
                                                <tr class="">
                                                    ...
                                                    <td>
                                                        ...
                                                        -->
                                                        <a class="btn btn-danger btn-xs btn_width delete_button" href="meeting/delete?id=<?php echo $meeting->id; ?>&doctor_id=<?php echo $meeting->doctor; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"> </i></a>
                                                    </td>
                                                </tr>
                                                <?php
                                            }
