                                                        ...
                                                        <tr class="">
                                                            ...
                                                            <td class="no-print">
                                                                ...
                                                                <?php if ($todays_appointment->status == 'Confirmed') { ?>
                                                                    <a class="btn btn-cyan btn-xs" title=" <?php echo lang('start_video_call'); ?>" style="color: #fff;" href="meeting/instantLive?id=<?php echo $todays_appointment->id; ?> " target="_blank" onclick="return confirm('Are you sure you want to start the video call with this patient? An SMS and Email reminder with the meeting link will be sent to the Patient.');"><i class="fa fa-headphones"></i> <?php echo lang('start_video_call'); ?> </a>
                                                                <?php } ?>
                                                            </td>
                                                        </tr>
                                                        <?php
                                            ...
                                            foreach ($holidays as $holiday) {
                                                ...
                                                <tr class="">
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="btn btn-danger btn-xs btn_width delete_button" href="schedule/deleteHoliday?id=<?php echo $holiday->id; ?>&doctor=<?php echo $doctor->id; ?>&redirect=doctor/details" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"> </i> <?php echo lang('delete'); ?></a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                            </tbody>
