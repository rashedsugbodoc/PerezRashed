    ...
    <!--body-->
                        ...
                        <div class="row mt-5 mb-5" id="actionbuttons">
                            <div class="col-md-12 col-sm-12 col-lg-12">
                                ...
                                <div class="row page-rightheader ml-auto .d-block d-print-none">
                                    <div class="flex-grow-1">
                                        <a href="patient/myPaymentHistory" class="btn btn-cyan"><i class="fe fe-arrow-left"></i><span class="button-text"> <?php echo lang('back_to_all_bills'); ?></span></a>
                                    </div>
                                    ...
                                    <div class="flex-grow-1 mr-3">
                                        <?php if ($this->ion_auth->in_group(array('admin', 'Accountant'))) { ?>
                                            <a href="finance/editPayment?id=<?php echo $payment->id; ?>" class="btn btn-info pull-right"><i class="fe fe-edit"></i><span class="button-text"> <?php echo lang('edit'); ?> <?php echo lang('invoice'); ?></span></a>
                                        <?php } ?>
                                    ...
                                    <div class="card-body pt-0">
                                        <div class="row border-bottom border-dark">
                                            ...
                                            <div class="col-md-6 col-sm-12 text-center">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 col-sm-12">
                                                        <label class="h3"><?php echo lang('patient');?> <?php echo lang('bill') ?></label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                    ...
                                                    <table class="table text-nowrap mb-1 mt-1" id="example2">
                                                        <tbody>
                                                            <tr class="p-0">
                                                                ...
                                                                <td></td>
                                                                <td class="w-15 p-0">
                                                                    <span class="pull-right"><?php echo lang('bill');?> <?php echo lang('id');?></span>
                                                                </td>
                                                                <td class="w-7 p-0">
                                                                    <span>: </span>
                                                                </td>
        ...
        <script>
            document.getElementById('create_pdf').onclick = function() {
                ...
                var opt = {
                    margin: 0.2,
                    filename: 'Bill_ID_<?php echo $payment->id;?><?php if (!empty($patient)) { echo '_Patient_ID_'.$patient->id; } ?>.pdf',
