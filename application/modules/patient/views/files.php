                                ...
                                <?php foreach ($medical_histories as $medical_history) { ?>
                                    <tr class="">
                                        ...
                                        <td class="no-print">
                                            ...
                                            <a class="btn btn-danger btn-xs btn_width delete_button" href="medical_history/delete?id=<?php echo $medical_history->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash-o"></i> <?php echo lang('delete'); ?></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                                    ...
                                    <tr class="">
                                        ...
                                        <td class="no-print">
                                            ...
                                            <?php if ($this->ion_auth->in_group('Doctor')) { ?>
                                                ...
                                                <a class="btn btn-danger btn-xs btn_width delete_button" href="prescription/delete?id=<?php echo $prescription->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash-o"></i> <?php echo lang('delete'); ?></a>
                                            <?php } ?>
                                        </td>
                                    </tr>
                                <?php } ?>
