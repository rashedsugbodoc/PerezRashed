<!--html-->
                                ...
                                <div class="card mt-5">
                                    <div class="card-header">
                                        <div class="card-title">
                                            <?php
                                            if (!empty($clerk->id))
                                                echo lang('edit_clerk');
                                            else
                                                echo lang('add_clerk');
                                            ?>
                                        </div>
                                    </div>
                                    <form id="clerkForm" role="form" action="clerk/addNew" class="clearfix" method="post" enctype="multipart/form-data" onsubmit="btnLoading('clerkForm');">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        } elseif (!empty($clerk->firstname)) {
                                                            echo $clerk->firstname;
                                                        }
                                                        ?>" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        } elseif (!empty($clerk->middlename)) {
                                                            echo $clerk->middlename;
                                                        }
                                                        ?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select2 br-0 nice-select br-tl-0 br-bl-0" name="suffix">
                                                            ...
                                                            <option value="Jr." <?php if(set_value('suffix')=='Jr.') { echo 'selected';} elseif(!empty($clerk->suffix)) { if($clerk->suffix ==='Jr.') { echo 'selected'; } } ?>><?php echo lang('jr'); ?></option>
                                                            <option value="Sr." <?php if(set_value('suffix')=='Sr.') { echo 'selected';} elseif(!empty($clerk->suffix)) { if($clerk->suffix ==='Sr.') { echo 'selected'; } } ?>><?php echo lang('sr'); ?></option>
                                                            <option value="I." <?php if(set_value('suffix')=='I.') { echo 'selected';} elseif(!empty($clerk->suffix)) { if($clerk->suffix ==='I.') { echo 'selected'; } } ?>><?php echo lang('i'); ?></option>
                                                            <option value="II." <?php if(set_value('suffix')=='II.') { echo 'selected';} elseif(!empty($clerk->suffix)) { if($clerk->suffix ==='II.') { echo 'selected'; } } ?>><?php echo lang('ii'); ?></option>
                                                            <option value="III." <?php if(set_value('suffix')=='III.') { echo 'selected';} elseif(!empty($clerk->suffix)) { if($clerk->suffix ==='III.') { echo 'selected'; } } ?>><?php echo lang('iii'); ?></option>
                                                            <option value="IV." <?php if(set_value('suffix')=='IV.') { echo 'selected';} elseif(!empty($clerk->suffix)) { if($clerk->suffix ==='IV.') { echo 'selected'; } } ?>><?php echo lang('iv'); ?></option>
                                                            <option value="V." <?php if(set_value('suffix')=='V.') { echo 'selected';} elseif(!empty($clerk->suffix)) { if($clerk->suffix ==='V.') { echo 'selected'; } } ?>><?php echo lang('v'); ?></option>
                                                            <option value="VI." <?php if(set_value('suffix')=='VI.') { echo 'selected';} elseif(!empty($clerk->suffix)) { if($clerk->suffix ==='VI.') { echo 'selected'; } } ?>><?php echo lang('vi'); ?></option>
                                                            <option value="VII." <?php if(set_value('suffix')=='VII.') { echo 'selected';} elseif(!empty($clerk->suffix)) { if($clerk->suffix ==='VII.') { echo 'selected'; } } ?>><?php echo lang('vii'); ?></option>
                                                            <option value="VIII." <?php if(set_value('suffix')=='VIII.') { echo 'selected';} elseif(!empty($clerk->suffix)) { if($clerk->suffix ==='VIII.') { echo 'selected'; } } ?>><?php echo lang('viii'); ?></option>
                                                            <option value="IX." <?php if(set_value('suffix')=='IX.') { echo 'selected';} elseif(!empty($clerk->suffix)) { if($clerk->suffix ==='IX.') { echo 'selected'; } } ?>><?php echo lang('ix'); ?></option>
                                                            <option value="X." <?php if(set_value('suffix')=='X.') { echo 'selected';} elseif(!empty($clerk->suffix)) { if($clerk->suffix ==='X.') { echo 'selected'; } } ?>><?php echo lang('x'); ?></option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select2" name="country_id" id="country" required>
                                                            ...
                                                            <?php foreach ($countries as $country) { ?>
                                                                ...
                                                                } elseif (!empty($clerk->country_id)) {
                                                                    if ($country->id == $clerk->country_id) {
                                                                        echo 'selected';
                                                                    }
                                                                }
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 col-md-12">
                                                    ...
                                                    <input type="file" name="img_url" id="img" class="dropify" data-default-file="<?php if(!empty($clerk->img_url)) echo $clerk->img_url; ?>"/>
                                                </div>
                                            </div>
                                            <input type="hidden" name="id" id="clerk_id" value='<?php
                                            if (!empty($clerk->id)) {
                                                echo $clerk->id;
                                            }
                                            ?>'>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            if (setval != "") {
                $.ajax({
                    url: 'clerk/getStateByCountryIdByJason?country=' + country,
                    method: 'GET',
                    data: '',
                    dataType: 'json',
                    success: function (response) {
                        ...
                        $.ajax({
                            url: 'clerk/getCityByStateIdByJason?state=' + state,
                            method: 'GET',
                            data: '',
                            dataType: 'json',
                            success: function (response) {
                                ...
                                $.ajax({
                                    url: 'clerk/getBarangayByCityIdByJason?city=' + city,
                                    method: 'GET',
                                    data: '',
                                    dataType: 'json',
                                    success: function (response) {
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var iid = $("#clerk_id").val();

            $.ajax({
                url: 'clerk/editClerkByJason?id=' + iid,
                method: 'GET',
                data: '',
                dataType: 'json',
                success: function (response) {
                    var clerk_country = response.clerk.country_id;
                    var clerk_state = response.clerk.state_id;
                    var clerk_city = response.clerk.city_id;
                    var clerk_barangay = response.clerk.barangay_id;

                    $("#state").find('option').remove();
                    $("#city").find('option').remove();
                    $("#barangay").find('option').remove();

                    console.log('Edit Clerk Country');

                    if (clerk_country == null) {
                        $("#state").attr("disabled", true);
                    } else {
                        $("#state").attr("disabled", false);
                    }
                    ...
                    $.ajax({
                        url: 'clerk/getStateByCountryIdByJason?country=' + clerk_country,
                        method: 'GET',
                        data: '',
                        dataType: 'json',
                        success: function (response) {
                            ...
                            console.log('Edit Clerk - Load State of Country');
                            ...
                            $.ajax({
                                url: 'clerk/getCityByStateIdByJason?state=' + clerk_state,
                                method: 'GET',
                                data: '',
                                dataType: 'json',
                                success: function (response) {
                                    ...
                                    console.log('Edit Clerk - Load Cities of State');
                                    ...
                                    $.ajax({
                                        url: 'clerk/getBarangayByCityIdByJason?city=' + clerk_city,
                                        method: 'GET',
                                        data: '',
                                        dataType: 'json',
                                        success: function (response) {
                                            ...
                                            console.log('Edit Clerk - Load Barangays of City');

                                            $.each(barangay, function (key, value) {
                                                $('#barangay').append($('<option>').text(value.name).val(value.id)).end();
                                            });

                                            if (clerk_barangay == null) {
                                                $('#barangay').val("0");
                                            } else {
                                                $('#barangay').val(clerk_barangay);
                                            }
                                        }
                                    });
                                }
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#state").change(function () {
                ...
                $.ajax({
                    url: 'clerk/getCityByStateIdByJason?state=' + stateval,
                    method: 'GET',
                    data: '',
                    dataType: 'json',
                    success: function (response) {
            ...
            $("#city").change(function () {
                ...
                $.ajax({
                    url: 'clerk/getBarangayByCityIdByJason?city=' + cityval,
                    method: 'GET',
                    data: '',
                    dataType: 'json',
                    success: function (response) {
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var form = document.getElementById("clerkForm");
