<!--html-->
                        ...
                        <section id="main-content">
                            <section class="wrapper site-min-height">
                                <div class="card mt-5">
                                    ...
                                    <form id="pharmacistForm" role="form" action="pharmacist/addNew" class="clearfix" method="post" enctype="multipart/form-data" onsubmit="btnLoading('pharmacistForm');">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        } elseif (!empty($pharmacist->firstname)) {
                                                            echo $pharmacist->firstname;
                                                        } else {
                                                            echo '';
                                                        }
                                                        ?>" required>
                                                ...
                                                <div class="col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        } elseif (!empty($pharmacist->middlename)) {
                                                            echo $pharmacist->middlename;
                                                        } else {
                                                            echo '';
                                                        }
                                                        ?>">
                                                ...
                                                <div class="col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        } elseif (!empty($pharmacist->lastname)) {
                                                            echo $pharmacist->lastname;
                                                        } else {
                                                            echo '';
                                                        }
                                                        ?>" required>
                                                ...
                                                <div class="col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select2 br-0 nice-select br-tl-0 br-bl-0" name="suffix">
                                                            ...
                                                            <option value="Jr." <?php if(set_value('suffix')=='Jr.') { echo 'selected';} elseif(!empty($pharmacist->suffix)) { if($pharmacist->suffix ==='Jr.') { echo 'selected'; } } ?>><?php echo lang('jr'); ?></option>
                                                            <option value="Sr." <?php if(set_value('suffix')=='Sr.') { echo 'selected';} elseif(!empty($pharmacist->suffix)) { if($pharmacist->suffix ==='Sr.') { echo 'selected'; } } ?>><?php echo lang('sr'); ?></option>
                                                            <option value="I." <?php if(set_value('suffix')=='I.') { echo 'selected';} elseif(!empty($pharmacist->suffix)) { if($pharmacist->suffix ==='I.') { echo 'selected'; } } ?>><?php echo lang('i'); ?></option>
                                                            <option value="II." <?php if(set_value('suffix')=='II.') { echo 'selected';} elseif(!empty($pharmacist->suffix)) { if($pharmacist->suffix ==='II.') { echo 'selected'; } } ?>><?php echo lang('ii'); ?></option>
                                                            <option value="III." <?php if(set_value('suffix')=='III.') { echo 'selected';} elseif(!empty($pharmacist->suffix)) { if($pharmacist->suffix ==='III.') { echo 'selected'; } } ?>><?php echo lang('iii'); ?></option>
                                                            <option value="IV." <?php if(set_value('suffix')=='IV.') { echo 'selected';} elseif(!empty($pharmacist->suffix)) { if($pharmacist->suffix ==='IV.') { echo 'selected'; } } ?>><?php echo lang('iv'); ?></option>
                                                            <option value="V." <?php if(set_value('suffix')=='V.') { echo 'selected';} elseif(!empty($pharmacist->suffix)) { if($pharmacist->suffix ==='V.') { echo 'selected'; } } ?>><?php echo lang('v'); ?></option>
                                                            <option value="VI." <?php if(set_value('suffix')=='VI.') { echo 'selected';} elseif(!empty($pharmacist->suffix)) { if($pharmacist->suffix ==='VI.') { echo 'selected'; } } ?>><?php echo lang('vi'); ?></option>
                                                            <option value="VII." <?php if(set_value('suffix')=='VII.') { echo 'selected';} elseif(!empty($pharmacist->suffix)) { if($pharmacist->suffix ==='VII.') { echo 'selected'; } } ?>><?php echo lang('vii'); ?></option>
                                                            <option value="VIII." <?php if(set_value('suffix')=='VIII.') { echo 'selected';} elseif(!empty($pharmacist->suffix)) { if($pharmacist->suffix ==='VIII.') { echo 'selected'; } } ?>><?php echo lang('viii'); ?></option>
                                                            <option value="IX." <?php if(set_value('suffix')=='IX.') { echo 'selected';} elseif(!empty($pharmacist->suffix)) { if($pharmacist->suffix ==='IX.') { echo 'selected'; } } ?>><?php echo lang('ix'); ?></option>
                                                            <option value="X." <?php if(set_value('suffix')=='X.') { echo 'selected';} elseif(!empty($pharmacist->suffix)) { if($pharmacist->suffix ==='X.') { echo 'selected'; } } ?>><?php echo lang('x'); ?></option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-12">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        } elseif (!empty($pharmacist->address)) {
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select2" name="country_id" id="country" required>
                                                            ...
                                                            <?php foreach ($countries as $country) { ?>
                                                                ...
                                                                } elseif (!empty($pharmacist->country_id)) {
                                                ...
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="postal" class="form-control" value="<?php
                                                            ...
                                                            } elseif (!empty($pharmacist->postal)) {
            ...
            if (setval != "") {
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $.ajax({
                            url: 'pharmacist/getCityByStateIdByJason?state=' + state,
                            method: 'GET',
                            data: '',
                            dataType: 'json',
                            success: function (response) {
                                ...
                                $.ajax({
                                    url: 'pharmacist/getBarangayByCityIdByJason?city=' + city,
                                    method: 'GET',
                                    data: '',
                                    dataType: 'json',
                                    success: function (response) {
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    console.log('Edit Pharmacist Country');
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            console.log('Edit Pharmacist - Load State of Country');
                            ...
                            $.ajax({
                                ...
                                success: function (response) {
                                    ...
                                    console.log('Edit Pharmacist - Load Cities of State');
                                    ...
                                    $.ajax({
                                        ...
                                        success: function (response) {
                                            ...
                                            console.log('Edit Pharmacist - Load Barangays of City');

                                            $.each(barangay, function (key, value) {
                                                $('#barangay').append($('<option>').text(value.name).val(value.id)).end();
                                            });

                                            if (pharmacist_barangay == null) {
                                                $('#barangay').val("0");
                                            } else {
                                                $('#barangay').val(pharmacist_barangay);
                                            }
                                        }
                                    });
                                }
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var form = document.getElementById("pharmacistForm");
