                            ...
                            foreach ($sents as $sent) {
                                ...
                                <tr class="">
                                    ...
                                    <td><?php
                                        ...
                                        ?></td>
                                    <td>
                                        <a class="btn btn-danger btn-xs btn_width delete_button" href="email/delete?id=<?php echo $sent->id; ?>" <?php echo lang('delete'); ?> onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"> </i></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
                ...
                buttons: [
                    {
                        ...
                        buttons: [
                            {
                                extend: 'copyHtml5',
                                title: '<?php echo lang('sent_messages'); ?>',
                                exportOptions: {
                                    columns: [0, 1, 2, 3],
                                }
                            },
