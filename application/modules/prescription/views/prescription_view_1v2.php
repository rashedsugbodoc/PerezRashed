                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="col-md-12 col-sm-12 header-brand pl-0">
                                                        <img src="<?php echo base_url('public/assets/images/brand/logo.png'); ?>" class="header-brand-img desktop-lgo pull-right" style="height: 60px;" alt="Rygel Dash logo">
                                        ...
                                        <div class="row pt-3">
                                            <div class="col-md-6 p-0">
                                                <div class="form-group mb-0">
                                                    <label class="form-label mb-0">Address : 23 Ramos Street, Unit 5, Cebu City</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3 p-0">
                                                <div class="form-group mb-0">
                                                    <label class="form-label mb-0">Prescription ID : 120</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3 p-0">
                                                <div class="form-group mb-0">
                                                    <label class="form-label mb-0">Date : 26-08-2021</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
