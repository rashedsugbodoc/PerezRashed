...
class Prescription extends MX_Controller {
    ...
    function getPrescriptionList() {
        ...
        foreach ($data['prescriptions'] as $prescription) {
            ...
            $option1 = '<a title="' . lang('view') . ' ' . lang('prescription') . '" class="btn btn-info btn-xs" href="prescription/viewPrescription?id=' . $prescription->id . '"><i class="fa fa-eye"></i> ' . lang('view') . ' ' . lang('prescription') . ' </a>';
            $option3 = '<a class="btn btn-info btn-xs" href="prescription/editPrescription?id=' . $prescription->id . '" data-id="' . $prescription->id . '"><i class="fa fa-edit"></i> ' . lang('edit') . ' ' . lang('prescription') . '</a>';
