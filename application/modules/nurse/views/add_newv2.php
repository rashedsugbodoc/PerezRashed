                                                ...
                                                <div class="col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select2 br-0 nice-select br-tl-0 br-bl-0" name="suffix">
                                                            ...
                                                            <option value="Jr." <?php if(set_value('suffix')=='Jr.') { echo 'selected';} elseif(!empty($nurse->suffix)) { if($nurse->suffix ==='Jr.') { echo 'selected'; } } ?>><?php echo lang('jr'); ?></option>
                                                            <option value="Sr." <?php if(set_value('suffix')=='Sr.') { echo 'selected';} elseif(!empty($nurse->suffix)) { if($nurse->suffix ==='Sr.') { echo 'selected'; } } ?>><?php echo lang('sr'); ?></option>
                                                            <option value="I." <?php if(set_value('suffix')=='I.') { echo 'selected';} elseif(!empty($nurse->suffix)) { if($nurse->suffix ==='I.') { echo 'selected'; } } ?>><?php echo lang('i'); ?></option>
                                                            <option value="II." <?php if(set_value('suffix')=='II.') { echo 'selected';} elseif(!empty($nurse->suffix)) { if($nurse->suffix ==='II.') { echo 'selected'; } } ?>><?php echo lang('ii'); ?></option>
                                                            <option value="III." <?php if(set_value('suffix')=='III.') { echo 'selected';} elseif(!empty($nurse->suffix)) { if($nurse->suffix ==='III.') { echo 'selected'; } } ?>><?php echo lang('iii'); ?></option>
                                                            <option value="IV." <?php if(set_value('suffix')=='IV.') { echo 'selected';} elseif(!empty($nurse->suffix)) { if($nurse->suffix ==='IV.') { echo 'selected'; } } ?>><?php echo lang('iv'); ?></option>
                                                            <option value="V." <?php if(set_value('suffix')=='V.') { echo 'selected';} elseif(!empty($nurse->suffix)) { if($nurse->suffix ==='V.') { echo 'selected'; } } ?>><?php echo lang('v'); ?></option>
                                                            <option value="VI." <?php if(set_value('suffix')=='VI.') { echo 'selected';} elseif(!empty($nurse->suffix)) { if($nurse->suffix ==='VI.') { echo 'selected'; } } ?>><?php echo lang('vi'); ?></option>
                                                            <option value="VII." <?php if(set_value('suffix')=='VII.') { echo 'selected';} elseif(!empty($nurse->suffix)) { if($nurse->suffix ==='VII.') { echo 'selected'; } } ?>><?php echo lang('vii'); ?></option>
                                                            <option value="VIII." <?php if(set_value('suffix')=='VIII.') { echo 'selected';} elseif(!empty($nurse->suffix)) { if($nurse->suffix ==='VIII.') { echo 'selected'; } } ?>><?php echo lang('viii'); ?></option>
                                                            <option value="IX." <?php if(set_value('suffix')=='IX.') { echo 'selected';} elseif(!empty($nurse->suffix)) { if($nurse->suffix ==='IX.') { echo 'selected'; } } ?>><?php echo lang('ix'); ?></option>
                                                            <option value="X." <?php if(set_value('suffix')=='X.') { echo 'selected';} elseif(!empty($nurse->suffix)) { if($nurse->suffix ==='X.') { echo 'selected'; } } ?>><?php echo lang('x'); ?></option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-12">
