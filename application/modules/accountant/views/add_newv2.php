                        ...
                        <section id="main-content">
                            <section class="wrapper site-min-height">
                                <div class="card mt-5">
                                    ...
                                    <form id="accountantForm" role="form" action="accountant/addNew" class="clearfix" method="post" enctype="multipart/form-data" onsubmit="btnLoading('accountantForm');">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        } elseif (!empty($accountant->firstname)) {
                                                            echo $accountant->firstname;
                                                        } else {
                                                            echo '';
                                                        }
                                                        ?>" required>
                                                ...
                                                <div class="col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        } elseif (!empty($accountant->middlename)) {
                                                            echo $accountant->middlename;
                                                        } else {
                                                            echo '';
                                                        }
                                                        ?>">
                                                ...
                                                <div class="col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        } elseif (!empty($accountant->lastname)) {
                                                            echo $accountant->lastname;
                                                        } else {
                                                            echo '';
                                                        }
                                                        ?>" required>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        } elseif (!empty($accountant->address)) {
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select2" name="country_id" id="country" required>
                                                            ...
                                                            <?php foreach ($countries as $country) { ?>
                                                                ...
                                                                } elseif (!empty($accountant->country_id)) {
                                                ...
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="postal" class="form-control" value="<?php
                                                            ...
                                                            } elseif (!empty($accountant->postal)) {
            ...
            if (setval != "") {
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $.ajax({
                            url: 'accountant/getCityByStateIdByJason?state=' + state,
                            method: 'GET',
                            data: '',
                            dataType: 'json',
                            success: function (response) {
                                ...
                                $.ajax({
                                    url: 'accountant/getBarangayByCityIdByJason?city=' + city,
                                    method: 'GET',
                                    data: '',
                                    dataType: 'json',
                                    success: function (response) {
