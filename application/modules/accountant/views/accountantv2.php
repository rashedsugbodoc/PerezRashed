                    ...
                    <!--div class="side-app"-->
                                ...
                                <section class="wrapper site-min-height">
                                    <div class="card">
                                        <div class="card-header">
                                            <div class="card-title"><?php echo lang('accountant'); ?></div>
                                                            ...
                                                            <?php foreach ($accountants as $accountant) { ?>
                                                                <tr class="">
                                                                    ...
                                                                    <td class="no-print">
                                                                        ...
                                                                        <a href="accountant/editAccountant?id=<?php echo $accountant->id ?>" class="btn btn-info"><i class="fa fa-edit"> </i> <?php echo lang('edit'); ?></a>
                                                                        <a class="btn btn-danger btn-xs" title="<?php echo lang('delete'); ?>" href="accountant/delete?id=<?php echo $accountant->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"> </i> <?php echo lang('delete'); ?></a>
                                                                    </td>
                                                                </tr>
                                                            <?php } ?>
                                                        </tbody>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content modal-content-demo">
                                    <div class="modal-header">
                                        <h6 class="modal-title"> <?php echo lang('add_accountant'); ?> </h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                                    </div>
                        ...
                        <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content modal-content-demo">
                                    <div class="modal-header">
                                        <h6 class="modal-title">  <?php echo lang('edit_accountant'); ?> </h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                                    </div>
        ...
        $(".table").on("click", ".editbutton", function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    var imagenUrl = response.accountant.img_url;
                ...
                buttons: [
                    {
                        ...
                        buttons: [
                            {
                                extend: 'copyHtml5',
                                title: '<?php echo lang('accountant'); ?>',
                                exportOptions: {
                                    columns: [0, 1, 2, 3, 4],
                                }
                            },
