    ...
    function getCaseList() {
        ...
        foreach ($data['cases'] as $case) {
            ...
            if ($this->ion_auth->in_group(array('Doctor', 'Midwife'))) {
                ...
                $options1 = ' <a href="casenote?id='.$case->case_note_number.'" class="btn btn-info btn-xs btn_width" title="' . lang('edit') . '"><i class="fa fa-edit"> </i>'.' '.lang('edit'). '</a>';
            }
            ...
            if ($this->ion_auth->in_group(array('admin', 'Accountant', 'Receptionist', 'Laboratorist', 'Nurse', 'Doctor', 'Midwife'))) {
                $options3 = ' <a type="button" class="btn btn-info btn-xs case" title="' . lang('details') . '" data-toggle = "modal" data-id="' . $case->id . '"><i class="fa fa-file-text-o"></i>'.' '. lang('details').'</a>';
            }
