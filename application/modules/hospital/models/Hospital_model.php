...
class Hospital_model extends CI_model {
    ...
    function createAutoSmsTemplate($hospital_id) {
        ...
        $data = array('0' => array(
            ...
            '2' => array(
                ...
                'message' => 'Dear {name}, Your appointment with Dr. {doctorname} on {appointmentdate} from {time_slot} is CONFIRMED. Login to sugbodoc.com with your email and click on Go Live at least 10 minutes before the schedule to prepare. For more information, contact {hospital_name} at {hospital_contact}.',
    ...
    function createAutoEmailTemplate($hospital_id) {
        ...
        $data = array('0' => array(
            ...
            '5' => array(
                'name' => 'Doctor Registration Confirmation',
                'message' => '<div style="font-family: sans-serif;background-color: #eeeeef; padding: 50px 0; "><div style="max-width:640px; margin:0 auto; "><div style="color: #fff; text-align: center; background-color:#8e98db; padding: 30px; border-top-left-radius: 3px; border-top-right-radius: 3px; margin: 0;"><h1>Welcome to {hospital_name}</h1></div><div style="padding: 20px; background-color: rgb(255, 255, 255);color: rgb(85, 85, 85); font-size: 14px;"><p> Dear {name},<br><br>Welcome to {hospital_name}!</p><p> You are now registered as a doctor in {department} Department.</p><p> Login to <a href="{base_url}" target="_blank">sugbodoc.com</a> to view and manage Patient Health Records, Manage Appointments, Start a Video Consultation or Manage Bills of your patients.</p><p><br><b>Here are your login details:</b></p><hr><p><b>Login URL:</b>&nbsp;<a href="{base_url}" target="_blank">sugbodoc.com</a></p><p></p><p style=""><span><b>Email:</b> {email}</span><br></p><p style=""><span><b>Password:</b> {password}</span><br></p><br><p> Make sure you change your password after your first login.</p><p> We look forward to being your partner in patient healthcare management.</p><p><br></p><p><b>{hospital_name}</b></p><p>{hospital_contact}</p></div></div></div>',
                'type' => 'doctor',
                'status' => 'Active',
            ),
            '6' => array(
                'name' => 'Patient Registration Confirmation',
                'message' => '<div style="font-family: sans-serif;background-color: #eeeeef; padding: 50px 0; "><div style="max-width:640px; margin:0 auto; "><div style="color: #fff; text-align: center; background-color:#8e98db; padding: 30px; border-top-left-radius: 3px; border-top-right-radius: 3px; margin: 0;"><h1>Welcome to {hospital_name}</h1></div><div style="padding: 20px; background-color: rgb(255, 255, 255); color: rgb(85, 85, 85); font-size: 14px;"><p> Dear {name},<br><br>Welcome to SugboDoc!</p><p> You are now registered as a patient of Dr. {doctor}.</p><p> Login to <a href="{base_url}" target="_blank">sugbodoc.com</a> to view your Patient Records, Book Appointments, Start a Video Consultation with any of our doctors or Pay for your Bills from the comfort of your home.</p><p><br><b>Here are your login details:</b></p><hr><p><b>Login URL:</b>&nbsp;<a href="{base_url}" target="_blank">sugbodoc.com</a></p><p></p><p style=""><span><b>Email:</b> {email}</span><br></p><p style=""><span><b>Password:</b> {password}</span><br></p><br><p> Make sure you change your password after your first login.</p><p> We look forward to managing your care wherever you are.</p><p><br></p><p><b>{hospital_name}</b></p><p>{hospital_contact}</p></div></div></div>',
                'type' => 'patient',
                'status' => 'Active',
        ));
