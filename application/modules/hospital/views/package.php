                        ...
                        foreach ($packages as $package) {
                            ...
                            <tr class="">
                                ...
                                <td class="no-print">
                                    ...
                                    <a class="btn btn-danger btn-xs btn_width delete_button" href="hospital/package/delete?id=<?php echo $package->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                            <?php
                        }
