                ...
                <div class="adv-table editable-table">
                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        ...
                        foreach ($hospitals as $hospital) {
                            ...
                            $settings = $this->db->get_where('settings', array('hospital_id' => $hospital->id))->row();
                            ...
                            if ($active != 1) {
                                ...
                                <tr class="">
                                    ...
                                    <td>
                                        <?php
                                        $active = $this->db->get_where('settings', array('hospital_id' => $hospital->id))->row()->active;
                                        if ($active == '1') {
                                            ?>
                                    ...
                                    <td class="no-print">
                                        ...
                                        if ($status == '1') {
                                            ?>
                                            <a href="hospital/disablelogin?hospital_id=<?php echo $hospital->ion_user_id; ?>&redirect=deactivated" type="button" class="btn btn-default btn-xs" data-toggle="modal" data-id="<?php echo $hospital->id; ?>"><?php echo lang('disable').' '.lang('login'); ?></a>  

                                        <?php } else {
                                            ?>

                                            <a href="hospital/enablelogin?hospital_id=<?php echo $hospital->ion_user_id; ?>&redirect=deactivated" type="button" class="btn btn-success btn-xs" data-toggle="modal" data-id="<?php echo $hospital->id; ?>"><?php echo lang('enable').' '.lang('login'); ?></a>  
                                            <?php
                                        }
                                        ?>
                                        <?php
                                        ...
                                        if ($active == '1') {
                                            ?>
                                            <a href="hospital/deactivate?hospital_id=<?php echo $hospital->id; ?>&redirect=deactivated" type="button" class="btn btn-default btn-xs" data-toggle="modal" data-id="<?php echo $hospital->id; ?>"><?php echo lang('deactivate'); ?></a>  

                                        <?php } else {
                                            ?>

                                            <a href="hospital/activate?hospital_id=<?php echo $hospital->id; ?>&redirect=deactivated" type="button" class="btn btn-success btn-xs" data-toggle="modal" data-id="<?php echo $hospital->id; ?>"><?php echo lang('activate'); ?></a>  
                                            <?php
                                        }
                                        ?>                                        
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><i class="fa fa-plus"></i>  <?php echo lang('create_new_hospital'); ?></h4>
            </div>
