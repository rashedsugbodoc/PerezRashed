                            ...
                            if ($status == '0') {
                                ...
                                <tr class="">
                                    ...
                                    <td class="no-print">
                                        ...
                                        if ($status == '1') {
                                            ?>
                                            <a href="hospital/deactivate?hospital_id=<?php echo $hospital->ion_user_id; ?>&redirect=deactive" type="button" class="btn btn-default btn-xs" data-toggle="modal" data-id="<?php echo $hospital->id; ?>"><?php echo lang('disable'); ?></a>  

                                        <?php } else {
                                            ?>

                                            <a href="hospital/activate?hospital_id=<?php echo $hospital->ion_user_id; ?>&redirect=deactive" type="button" class="btn btn-success btn-xs" data-toggle="modal" data-id="<?php echo $hospital->id; ?>"><?php echo lang('enable'); ?></a>  
                                            <?php
                                        }
                                        ?>
