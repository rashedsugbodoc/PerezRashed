                            ...
                            if ($slot->weekday == 'Monday') {
                                ...
                                <tr class="">
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-danger btn-xs btn_width delete_button" href="schedule/deleteTimeSlot?id=<?php echo $slot->id; ?>&doctor=<?php echo $doctorr; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"> </i> <?php echo lang('delete'); ?></a>
                                    </td>
                                </tr>
                            <?php }
                        } ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><i class="fa fa-plus"></i>  <?php echo lang('add'); ?> <?php echo lang('time_slots'); ?></h4>
            </div>
