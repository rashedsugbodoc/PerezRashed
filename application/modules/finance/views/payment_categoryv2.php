                                                    ...
                                                    <tbody>
                                                        <?php foreach ($categories as $category) { ?>
                                                            <tr class="">
                                                                ...
                                                                <?php if ($this->ion_auth->in_group(array('admin', 'Accountant', 'Doctor', 'Clerk'))) { ?>
                                                                    <td class="no-print">
                                                                        <a class="btn btn-info btn-xs editbutton" title="<?php echo lang('edit'); ?>" href="finance/editPaymentCategory?group_id=<?php echo $category->group_id.'&charge_id='.$category->id; ?>"><i class="fa fa-edit"> </i></a>
