                        ...
                        <?php foreach ($payments as $payment) { ?>
                            ...
                            <tr class="">
                                ...
                                <td> 
                                    ...
                                    <?php if ($this->ion_auth->in_group('admin')) { ?> 
                                        <a class="btn btn-danger btn-xs delete_button width_auto" href="finance/pharmacy/delete?id=<?php echo $payment->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash-o"></i>  <?php echo lang('delete'); ?></a>
                                    <?php } ?>
                                    </button>
                                </td>
                            </tr>
