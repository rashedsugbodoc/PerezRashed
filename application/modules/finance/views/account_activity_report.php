            ...
            <div class="col-md-12">
                <?php if ($this->ion_auth->in_group(array('Receptionist'))) { ?>
                    ...
                    <section class="col-md-6 no-print">
                        <form role="form" class="f_report" action="finance/accountActivityReportDateWise" method="post" enctype="multipart/form-data">
                        ...
                        <section class="col-md-12 no-print">
                            <form role="form" class="f_report" action="finance/allAccountActivityReportDateWise" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4 no-print text-center">
                                        <button type="submit" name="submit" class="btn btn-primary range_submit"><?php echo lang('submit'); ?></button>
                                    </div>
                                </div>
                            </form>
