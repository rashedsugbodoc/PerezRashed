                    ...
                    <!--div class="side-app"-->
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h6 class="modal-title"> <?php echo lang('add_new_bed'); ?> </h6>
                                    ...
                                    <div class="modal-body">
                                        <form role="form" action="bed/addBed" class="clearfix" method="post" enctype="multipart/form-data">
                                            <div class="row">
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-group">
                                                        <label class="form-label"><?php echo lang('bed_category'); ?></label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-group">
                                                        <label class="form-label"><?php echo lang('bed_number'); ?></label>
                        ...
                        <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h6 class="modal-title"> <?php echo lang('edit_bed'); ?> </h6>
                                        <button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                                    </div>
                                    <div class="modal-body">
                                        <form role="form" id="editBedForm" class="clearfix" action="bed/addBed" method="post" enctype="multipart/form-data">
                                            <div class="row">
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-group">
                                                        <label class="form-label"><?php echo lang('bed_category'); ?></label>
            ...
            $(".table").on("click", ".editbutton", function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $('#editBedForm').find('[name="category"]').val(response.bed.category).change()
