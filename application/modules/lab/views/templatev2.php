                            ...
                            <div class="col-md-12 col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <div class="card-title"><?php echo lang('lab_report'); ?> <?php echo lang('template'); ?></div>
                                                ...
                                                <tbody>
                                                    <?php foreach ($templates as $template) { ?>
                                                        <tr class="">
                                                            ...
                                                            <td class="no-print">
                                                                <a href="lab/editTemplate?id=<?php echo $template->id;?>" class="btn btn-info btn-xs editbutton" title="<?php echo lang('edit'); ?>" data-id="<?php echo $template->id; ?>"><i class="fa fa-edit"> </i></a>   
