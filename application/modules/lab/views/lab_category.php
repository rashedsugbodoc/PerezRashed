                            ...
                            <tr class="">
                                ...
                                <?php if ($this->ion_auth->in_group(array('admin', 'Accountant'))) { ?>
                                    <td class="no-print">
                                        ...
                                        <a class="btn btn-danger btn-xs delete_button" title="<?php echo lang('delete'); ?>" href="lab/deleteLabCategory?id=<?php echo $category->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"></i> </a>
                                    </td>
                                <?php } ?>
                            </tr>
                        <?php } ?>
