                        ...
                        <div class="col-md-12">
                            <div class="col-md-6 pull-left row" style="text-align: left;">
                                <div class="col-md-12 row details" style="">
                                    <p>
                                        <?php $patient_info = $this->db->get_where('patient', array('id' => $form->patient))->row(); ?>
                            ...
                            <div class="col-md-6 pull-right" style="text-align: left;">
                                ...
                                <div class="col-md-12 row details" style="">
                                    <p>
                                        <label class="control-label"> <?php echo lang('form'); ?> <?php echo lang('report'); ?> <?php echo lang('id'); ?>  </label>
                                        <span style="text-transform: uppercase;"> : 
                                            <?php
                                            if (!empty($form->id)) {
                                                echo $form->id;
                                    ...
                                    <p>
                                        ...
                                        <span style="text-transform: uppercase;"> : 
                                            ...
                                            if (!empty($form->doctor)) {
                                                $doctor_details = $this->doctor_model->getDoctorById($form->doctor);
        ...
        <section class="col-md-6">
            <div class="col-md-5 no-print" style="margin-top: 20px;">
                <div class="text-center col-md-12 row">
                    ...
                    <a href="form" class="btn btn-info btn-sm info pull-left"><i class="fa fa-arrow-circle-left"></i>  <?php echo lang('back_to_form_module'); ?> </a>
                    <?php }?>
                    <?php if ($this->ion_auth->in_group(array('Patient'))) { ?>
                    <a href="form/myForm" class="btn btn-info btn-sm info pull-left"><i class="fa fa-arrow-circle-left"></i>  <?php echo lang('back_to_form_module'); ?> </a>
                    <?php }?>
                    ...
                    <?php if ($this->ion_auth->in_group(array('admin', 'Laboratorist'))) { ?>
                        <a href="form?id=<?php echo $form->id; ?>" class="btn btn-info btn-sm blue pull-left"><i class="fa fa-edit"></i> <?php echo lang('edit_report'); ?> </a>
                    <?php } ?>
...
<script>
                        ...
                        $('#download').click(function () {
                            ...
                            pdf.addHTML($('#form'), function () {
                                pdf.save('form_id_<?php echo $form->id; ?>.pdf');
                            });
                        });
